    ...
    <div className='flex flex-col h-screen w-full bg-gray-900 text-white'>
     ...
     <div className='flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar'>
      ...
      <div className='flex items-center gap-2 sm:min-w-90 text-nowrap'>
        <img src="/nirman.png" alt="logo" className='h-7 cursor-pointer' onClick={()=> navigate('/')} />
        ...
        <div className='sm:hidden flex-1 flex justify-end'>
          {isMeunOpen ? <MessageSquareIcon onClick={()=> setIsMeunOpen(false)} className='size-7 cursor-pointer' />
          : <XIcon onClick={()=> setIsMeunOpen(true)} className='size-7 cursor-pointer' />}
        </div>
      </div>
      {/* middle */}
     ...
     <div className='flex-1 flex overflow-auto'>
              <Sidebar isMenuOpen={isMeunOpen} project={project} setProject={(p)=>setProject(p)} isGenerating={isGenerating} setIsGenerating={setIsGenerating} />
